# cloud-mode-api-server Specification

## Purpose
Defines the optional Cloud Mode service and extension behavior: registration/login, Supabase/Postgres-backed user Capture storage, manual local backfill, local fallback, and personal cloud data viewing inside the extension options page.
## Requirements
