# Spec: realtime-capture

## Purpose

Content script real-time conversation capture on ChatGPT pages using MutationObserver. Tracks messages as they appear in the DOM, gates saving on conversationId availability, and supports auto-save mode that fires after each assistant turn completes.
